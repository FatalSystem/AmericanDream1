            ...
            <div className="flex flex-col gap-2 xs:flex-row">
              {auth.user?.role === "student" && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 px-5 py-3 text-sm font-medium text-white shadow-lg hover:from-emerald-600 hover:to-teal-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-all duration-200"
      ...
      >
        ...
        <Modal.Body style={{backgroundColor: "#0f172a", padding: "1rem", overflow: "visible"}}>
          <div className="flex flex-col h-full">
            <div className="stripe-container flex-grow" style={{ width: "100%" }}>
              {stripeScriptError ? (
                <div className="flex h-full w-full flex-col items-center justify-center bg-[#0f172a] p-8">
            ...
            <div className="fixed-button-container mt-4 pt-2 border-t border-slate-700 flex justify-end">
              <Button
                color="light"
                onClick={() => setShowStripeModal(false)}
                className="px-5 py-2.5 bg-slate-700 text-white hover:bg-slate-600"
              >
                Close
              </Button>
            </div>
