...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen w-screen flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 px-4 dark:from-gray-900 dark:to-gray-800">
      <div className="text-center">
        ...
        >
          <h1 className="relative mb-4 text-[150px] font-bold leading-none tracking-tight text-gray-900 dark:text-white md:text-[200px]">
            ...
            <motion.div
              className="absolute -right-4 top-0 size-24 md:-right-6 md:size-32"
              initial={{ rotate: 0 }}
              animate={{ rotate: 360 }}
              transition={{
                duration: 20,
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <motion.div
            className="absolute left-1/4 top-1/4 size-16 rounded-full bg-blue-500/10"
            animate={{
              y: [0, -20, 0],
              scale: [1, 1.1, 1],
            }}
          ...
          />
          <motion.div
            className="absolute right-1/4 top-1/3 size-24 rounded-full bg-indigo-500/10"
            animate={{
              y: [0, 20, 0],
              scale: [1, 1.1, 1],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-1/4 left-1/3 size-20 rounded-full bg-purple-500/10"
            animate={{
              y: [0, -15, 0],
              scale: [1, 1.1, 1],
            }}
